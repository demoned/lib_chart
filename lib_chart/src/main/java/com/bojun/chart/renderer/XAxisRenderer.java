...
import com.bojun.chart.utils.FSize;
...
public class XAxisRenderer extends AxisRenderer {
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                if (mXAxis.yShowType == mXAxis.DATE) {
                    if (!TextUtils.isEmpty(label)) {
                        ...
                        drawLabel(c, longToStringhhmmss(Long.parseLong(label)), x, pos + 35, anchor, labelRotationAngleDegrees);
                    }
    ...
    public static String longToStringFromyyyyMMDD(long date) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        Date dt = new Date(date);
        return format.format(dt);
    }

    public static String longToStringhhmmss(long date) {
