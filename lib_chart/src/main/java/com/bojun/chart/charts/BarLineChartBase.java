...
import com.bojun.chart.components.XAxis.XAxisPosition;
...
import com.bojun.chart.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import com.bojun.chart.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.bojun.chart.jobs.AnimatedMoveViewJob;
import com.bojun.chart.jobs.AnimatedZoomJob;
import com.bojun.chart.jobs.MoveViewJob;
import com.bojun.chart.jobs.ZoomJob;
import com.bojun.chart.listener.BarLineChartTouchListener;
import com.bojun.chart.listener.OnDrawListener;
import com.bojun.chart.renderer.XAxisRenderer;
import com.bojun.chart.renderer.YAxisRenderer;
import com.bojun.chart.utils.LogUtil;
import com.bojun.chart.utils.MPPointD;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mLogEnabled) {
            ...
            LogUtil.i(LOG_TAG, "Drawtime: " + drawtime + " ms, average: " + average + " ms, cycles: "
                    + drawCycles);
        }
    }
    ...
    protected void prepareValuePxMatrix() {
        ...
        if (mLogEnabled)
            LogUtil.i(LOG_TAG, "Preparing Value-Px Matrix, xmin: " + mXAxis.mAxisMinimum + ", xmax: "
    ...
    public void notifyDataSetChanged() {
        ...
        if (mData == null) {
            if (mLogEnabled)
                LogUtil.i(LOG_TAG, "Preparing... DATA NOT SET.");
            return;
        } else {
            if (mLogEnabled)
                LogUtil.i(LOG_TAG, "Preparing...");
        }
    ...
    public void calculateOffsets() {
        ...
        if (!mCustomViewPortEnabled) {
            ...
            if (mLogEnabled) {
                LogUtil.i(LOG_TAG, "offsetLeft: " + offsetLeft + ", offsetTop: " + offsetTop
                        + ", offsetRight: " + offsetRight + ", offsetBottom: " + offsetBottom);
                LogUtil.i(LOG_TAG, "Content: " + mViewPortHandler.getContentRect().toString());
            }
        }
