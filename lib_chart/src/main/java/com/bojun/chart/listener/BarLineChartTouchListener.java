package com.bojun.chart.listener;
...
import com.bojun.chart.charts.BarLineChartBase;
import com.bojun.chart.charts.HorizontalBarChart;
    ...
    public boolean onDoubleTap(MotionEvent e) {
        ...
        if (mChart.isDoubleTapToZoomEnabled() && mChart.getData().getEntryCount() > 0) {
            ...
            if (mChart.isLogEnabled())
                LogUtil.i("BarlineChartTouch", "Double-Tap, Zooming In, x: " + trans.x + ", y: "
                        + trans.y);
